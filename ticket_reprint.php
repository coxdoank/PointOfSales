  ...
  <table width="100%" align="center" cellpadding="1" cellspacing="0" class="table-model">
    ...
    <tr>
      <td><table width="100%" cellpadding="1" cellspacing="0" class="table-model-01">
        ...
        <tr>
          <td colspan="3"><span class="text_content">Kasir : <?php if(empty($rows['FIRST_NAME'])){ echo $rows['LAST_NAME']; }else{ echo $rows['FIRST_NAME']; } ?></span><span class="text_content"> | <?php echo "$rows[CLOSING_DATE]" ?> Wib</span></td>
          </tr>
        ...
        <tr class="text_content">
          <td colspan="2"><span class="text_content">
			  <div><?php echo "$rwtrs[ITEM_NAME]" ?></div>
			  <div><?php echo "$rwtrs[ITEM_COUNT]" ?> x <?php echo number_format($rwtrs['ITEM_PRICE']) ?></div></span>
			</td>
